...
public class Combinations {
	...
	public void printResults(boolean b) {
		...
		System.out.println("\nNumber of Hands won through");
		for (int p = 0; p < 14; p++) {
			System.out.print(r[p] + "\t\t" + H[0].DR2[p]);
			if (players > 1) {
				System.out.print("\t" + H[1].DR2[p]);
			} //else
			//System.out.print("\t0");

			if (players > 2) {
				System.out.print("\t" + H[2].DR2[p]);
			} //else
			//System.out.print("\t0");
			if (players > 3) {
				System.out.print("\t" + H[3].DR[p]);
		...
		System.out.println("\nNumber of Hands tied through");
		for (int p = 0; p < 14; p++) {
			System.out.print(r[p] + "\t\t" + H[0].DR3[p]);
			if (players > 1) {
				System.out.print("\t" + H[1].DR3[p]);
			} //else
			//System.out.print("\t0");

			if (players > 2) {
				System.out.print("\t" + H[2].DR3[p]);
			} //else
			//System.out.print("\t0");
			if (players > 3) {
				System.out.print("\t" + H[3].DR[p]);
