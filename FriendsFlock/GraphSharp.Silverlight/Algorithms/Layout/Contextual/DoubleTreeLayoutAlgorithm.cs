...
namespace GraphSharp.Algorithms.Layout.Contextual
{
        ...
        where TGraph : IBidirectionalGraph<TVertex, TEdge>
    {
        ...
        protected override void InternalCompute()
        {
            ...
            // Merge the layouts
            //
            var side2Translate = side1LayoutAlg.VertexPositions[root].ToVector() - side2LayoutAlg.VertexPositions[root];
            foreach ( var v in side1 )
                VertexPositions[v] = side1LayoutAlg.VertexPositions[v];

            foreach ( var v in side2 )
                VertexPositions[v] = side2LayoutAlg.VertexPositions[v].ToVector() + side2Translate;
            NormalizePositions();
        }
