...
namespace GraphSharp.Algorithms.Layout.Simple.FDP
{
        ...
        where Graph : IBidirectionalGraph<Vertex, Edge>
    {
        ...
        {
            Stopwatch swInternalCompute = new Stopwatch();
            ...
            swInternalCompute.Restart("Calculate Diamter");
            ...
            Debug.WriteLine(string.Format("Diameter = {0}, IdealEdgeLength = {1}", diameter, idealEdgeLength));

            //calculating the ideal distance between the nodes
            swInternalCompute.Restart("Ideal Distance");
            ...
            swInternalCompute.Restart("Iterations");
